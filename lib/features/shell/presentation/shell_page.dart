...
const _sections = [
  ...
  _MenuSection('Operación', [
    ...
    _MenuItem(Icons.payment_outlined, 'Cobros', '/app/payments'),
  ...
  _MenuSection('Reportes', [
    ...
    _MenuItem(Icons.trending_up_outlined, 'Ventas', '/app/reports/sales'),
    _MenuItem(Icons.receipt_long_outlined, 'Pedidos', '/app/reports/orders'),
